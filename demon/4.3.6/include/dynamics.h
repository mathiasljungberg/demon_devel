...
C     MDNSR   : Molecular dynamics NSR constants.
...
C     NSRSTD  : Average and standard deviation of NSR constants.
C     NSRSUM  : Linear and quadratic sums of NSR constants.
...
C     TRJNSR  : True, if NSR constants are written to the trajectory.
...
C
      LOGICAL MDCONST,MDFLP,MDVLP,TRJACC,TRJDIP,TRJEXT,TRJGEO,TRJMAG,
     $        TRJMOS,TRJNHC,TRJNMR,TRJNSR,TRJPOL,TRJRDF,TRJROG,TRJOVL
C
      COMMON /LDYNAMICS/ MDCONST,MDFLP,MDVLP,TRJACC,TRJDIP,TRJEXT,
     $                   TRJGEO,TRJMAG,TRJMOS,TRJNHC,TRJNMR,TRJNSR,
     $                   TRJPOL,TRJRDF,TRJROG,TRJOVL
C
...
C
     ...
     $     NSRSTD(2,MAXATOM,0:3),NSRSUM(2,MAXATOM,0:3),POLSTD(2),
     $     POLSUM(2),EKINSTD(2),EKINSUM(2),EPOTSTD(2),EPOTSUM(2),
     $     ESYSSTD(2),ESYSSUM(2),ETOTSTD(2),ETOTSUM(2),ROGSTD(2),
     $     ROGSUM(2),SEPSTD(2),SEPSUM(2),TKINSTD(2),TKINSUM(2)
C
      REAL MDDIP(0:3),MDMAG(0:3),MDNMR(0:3,MAXATOM),MDNSR(0:3,MAXATOM),
     $     MDPOL(0:3),MDROG(0:3),NHCOORD(MAXNHC),NHFORCE(MAXNHC),
     $     NHVELOS(MAXNHC),QNOSE(MAXNHC),VARFIXED(3*MAXATOM_ALL)
C
     ...
     $                   MDDIP,MDDXI,MDMAG,MDNMR,MDNSR,MDPOL,MDRADIUS,
     $                   MDROG,MDSTEP,MDTAU,MDTEMP,MDTEMP0,MDTIME,
     $                   NHCOORD,NHFORCE,NHVELOS,NMRSTD,NMRSUM,NSRSTD,
     $                   NSRSUM,POLSTD,POLSUM,QNOSE,ROGSTD,ROGSUM,
     $                   SEPSTD,SEPSUM,THOOVER,TKIN,TKINSTD,TKINSUM,
     $                   VARFIXED
C
C     ------------------------------------------------------------------
